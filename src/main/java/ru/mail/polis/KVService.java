 ...
 * <li>{@code GET /v0/entity?id=<ID>} -- read data by {@code ID}. Returns {@code 200} and data if found, {@code 404} if not found.</li>
 * <li>{@code PUT /v0/entity?id=<ID>} -- put (create or replace) data by {@code ID}. Returns {@code 201}.</li>
